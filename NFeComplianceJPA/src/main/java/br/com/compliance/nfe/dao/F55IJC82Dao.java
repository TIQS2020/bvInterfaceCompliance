...
public class F55IJC82Dao {
	...
	public List<F55IJC82> listF55IJC82ById(F55IJC80Id id) {
		 ...
		 * "WHERE f55IJC82.JCBNNF = :JCBNNF " + "AND f55IJC82.JCBSER = :JCBSER " +
		 * "AND f55IJC82.JCN001 = :JCN001 " + "AND f55IJC82.JCDCT = :JCDCT";
		 * 
		 ...
		 * 
		 * try{ listF55IJC82 = query.getResultList(); }catch(NoResultException ex){
		 * 
		 * }
		 * 
		 */
	...
	public void insertF55IJC82(F55IJC82 f) throws JDBCException, SQLException {
