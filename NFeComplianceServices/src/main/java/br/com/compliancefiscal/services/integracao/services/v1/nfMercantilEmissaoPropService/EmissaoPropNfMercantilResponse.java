/**
 * EmissaoPropNfMercantilResponse.java
 *
...
public class EmissaoPropNfMercantilResponse  implements java.io.Serializable {
    private br.com.compliancefiscal.modelo.integracao.domain.v1.tiposGenericos.LoteIntWSResponse loteWSResponse;

    public EmissaoPropNfMercantilResponse() {
    }
    ...
    /**
     * Gets the loteWSResponse value for this EmissaoPropNfMercantilResponse.
     * 
    ...
    /**
     * Sets the loteWSResponse value for this EmissaoPropNfMercantilResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EmissaoPropNfMercantilResponse)) return false;
        EmissaoPropNfMercantilResponse other = (EmissaoPropNfMercantilResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EmissaoPropNfMercantilResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services.compliancefiscal.com.br/integracao/services/v1/nfMercantilEmissaoPropService", ">emissaoPropNfMercantilResponse"));
