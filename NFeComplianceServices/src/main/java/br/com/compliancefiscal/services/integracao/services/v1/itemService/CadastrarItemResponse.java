...
public class CadastrarItemResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the loteWSResponse value for this CadastrarItemResponse.
     * 
    ...
    /**
     * Sets the loteWSResponse value for this CadastrarItemResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarItemResponse)) return false;
        CadastrarItemResponse other = (CadastrarItemResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarItemResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services.compliancefiscal.com.br/integracao/services/v1/itemService", ">cadastrarItemResponse"));
