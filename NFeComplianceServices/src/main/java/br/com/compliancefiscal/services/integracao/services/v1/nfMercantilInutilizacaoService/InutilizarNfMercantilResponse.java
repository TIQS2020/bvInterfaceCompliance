/**
 * InutilizarNfMercantilResponse.java
 *
...
public class InutilizarNfMercantilResponse  implements java.io.Serializable {
    private br.com.compliancefiscal.modelo.integracao.domain.v1.tiposGenericos.LoteIntWSResponse loteWSResponse;

    public InutilizarNfMercantilResponse() {
    }
    ...
    /**
     * Gets the loteWSResponse value for this InutilizarNfMercantilResponse.
     * 
    ...
    /**
     * Sets the loteWSResponse value for this InutilizarNfMercantilResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InutilizarNfMercantilResponse)) return false;
        InutilizarNfMercantilResponse other = (InutilizarNfMercantilResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InutilizarNfMercantilResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services.compliancefiscal.com.br/integracao/services/v1/nfMercantilInutilizacaoService", ">inutilizarNfMercantilResponse"));
