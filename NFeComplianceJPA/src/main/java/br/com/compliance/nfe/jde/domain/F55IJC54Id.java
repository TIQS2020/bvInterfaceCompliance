...
@Embeddable
public class F55IJC54Id implements Serializable{
	...
	public F55IJC54Id(String jCCO, Long jCWJOBS, String jCBEGDATE, String jCENDDATE, Integer jCITM) {
		super();
		JCCO = jCCO;
		JCWJOBS = jCWJOBS;
		JCBEGDATE = jCBEGDATE;
	...
	public F55IJC54Id(String jCCO, Long jCWJOBS, String jCBEGDATE, String jCENDDATE) {
		super();
		JCCO = jCCO;
		JCWJOBS = jCWJOBS;
		JCBEGDATE = jCBEGDATE;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		F55IJC54Id other = (F55IJC54Id) obj;
		if (JCBEGDATE == null) {
