...
public class ServicesVO {
	...
	private String emissaoNFSeContServiceURL;
	...
	public String getEmissaoNFSeContServiceURL() {
		return emissaoNFSeContServiceURL;
	}

	public void setEmissaoNFSeContServiceURL(String emissaoNFSeContServiceURL) {
		this.emissaoNFSeContServiceURL = emissaoNFSeContServiceURL;
	}
