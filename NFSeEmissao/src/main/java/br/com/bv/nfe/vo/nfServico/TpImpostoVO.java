...
public class TpImpostoVO {
	...
	public static TpImpostos montaImposto(NonNegativeInteger codImposto, NonNegativeInteger tipo, String codSt,
			BigDecimal vlBaseCalc, BigDecimal aliquota, BigDecimal vlImpTrib, String naturezaReceitaPisCofins, String retencaoInss)
			throws Exception {
		...
		if(codImposto.compareTo(new BigInteger("12")) == 0 ||
				(codImposto.compareTo(new BigInteger("6")) == 0	&& tipo.compareTo(new NonNegativeInteger("1")) == 0)) {
