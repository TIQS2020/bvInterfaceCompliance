...
public class F4211 {
	...
	private Double SDDRQJ;
	private Double SDTRDJ;
	private Double SDPDDJ;
	private Double SDADDJ;
	private Double SDIVD;
	private Double SDCNDJ;
	private Double SDDGL;
	private Double SDRSDJ;
	private Double SDPEFJ;
	private Double SDPPDJ;
	...
	private String SDALLOC;
	private Double SDFULPID;
	private String SDALLSTS;
	private Double SDOSCORE;
	private String SDOSCOREO;
	private String SDCMCO;
	private Double SDKITID;
	private Double SDKITAMTDOM;
	private Double SDKITAMTFOR;
	private String SDKITDIRTY;
	private String SDOCITT;
	private Double SDOCCARDNO;
	private String SDPMPN;
	private Double SDPNS;
	
	public F4211() {
		super();
	}

	public F4211Id getId() {
		return id;
	}

	public void setId(F4211Id id) {
		this.id = id;
	}
	...
	public Double getSDDRQJ() {
		return SDDRQJ;
	}

	public void setSDDRQJ(Double sDDRQJ) {
		SDDRQJ = sDDRQJ;
	}

	public Double getSDTRDJ() {
		return SDTRDJ;
	}

	public void setSDTRDJ(Double sDTRDJ) {
		SDTRDJ = sDTRDJ;
	}

	public Double getSDPDDJ() {
		return SDPDDJ;
	}

	public void setSDPDDJ(Double sDPDDJ) {
		SDPDDJ = sDPDDJ;
	}

	public Double getSDADDJ() {
		return SDADDJ;
	}

	public void setSDADDJ(Double sDADDJ) {
		SDADDJ = sDADDJ;
	}

	public Double getSDIVD() {
		return SDIVD;
	}

	public void setSDIVD(Double sDIVD) {
		SDIVD = sDIVD;
	}

	public Double getSDCNDJ() {
		return SDCNDJ;
	}

	public void setSDCNDJ(Double sDCNDJ) {
		SDCNDJ = sDCNDJ;
	}

	public Double getSDDGL() {
		return SDDGL;
	}

	public void setSDDGL(Double sDDGL) {
		SDDGL = sDDGL;
	}

	public Double getSDRSDJ() {
		return SDRSDJ;
	}

	public void setSDRSDJ(Double sDRSDJ) {
		SDRSDJ = sDRSDJ;
	}

	public Double getSDPEFJ() {
		return SDPEFJ;
	}

	public void setSDPEFJ(Double sDPEFJ) {
		SDPEFJ = sDPEFJ;
	}

	public Double getSDPPDJ() {
		return SDPPDJ;
	}

	public void setSDPPDJ(Double sDPPDJ) {
		SDPPDJ = sDPPDJ;
	}
	...
	public Double getSDURDT() {
		return SDURDT;
	}

	public void setSDURDT(Double sDURDT) {
		SDURDT = sDURDT;
	}
	...
	public Long getSDUPMJ() {
		return SDUPMJ;
	}

	public void setSDUPMJ(Long sDUPMJ) {
		SDUPMJ = sDUPMJ;
	}

	public Long getSDTDAY() {
		return SDTDAY;
	}

	public void setSDTDAY(Long sDTDAY) {
		SDTDAY = sDTDAY;
	}
	...
	public Double getSDSOOR() {
		return SDSOOR;
	}

	public void setSDSOOR(Double sDSOOR) {
		SDSOOR = sDSOOR;
	}
	...
	public Double getSDRLDJ() {
		return SDRLDJ;
	}

	public void setSDRLDJ(Double sDRLDJ) {
		SDRLDJ = sDRLDJ;
	}
	...
	public Double getSDOPDJ() {
		return SDOPDJ;
	}

	public void setSDOPDJ(Double sDOPDJ) {
		SDOPDJ = sDOPDJ;
	}
	...
	public String getSDALLOC() {
		return SDALLOC;
	}

	public void setSDALLOC(String sDALLOC) {
		SDALLOC = sDALLOC;
	}

	public Double getSDFULPID() {
		return SDFULPID;
	}

	public void setSDFULPID(Double sDFULPID) {
		SDFULPID = sDFULPID;
	}

	public String getSDALLSTS() {
		return SDALLSTS;
	}

	public void setSDALLSTS(String sDALLSTS) {
		SDALLSTS = sDALLSTS;
	}

	public Double getSDOSCORE() {
		return SDOSCORE;
	}

	public void setSDOSCORE(Double sDOSCORE) {
		SDOSCORE = sDOSCORE;
	}

	public String getSDOSCOREO() {
		return SDOSCOREO;
	}

	public void setSDOSCOREO(String sDOSCOREO) {
		SDOSCOREO = sDOSCOREO;
	}

	public String getSDCMCO() {
		return SDCMCO;
	}

	public void setSDCMCO(String sDCMCO) {
		SDCMCO = sDCMCO;
	}

	public Double getSDKITID() {
		return SDKITID;
	}

	public void setSDKITID(Double sDKITID) {
		SDKITID = sDKITID;
	}

	public Double getSDKITAMTDOM() {
		return SDKITAMTDOM;
	}

	public void setSDKITAMTDOM(Double sDKITAMTDOM) {
		SDKITAMTDOM = sDKITAMTDOM;
	}

	public Double getSDKITAMTFOR() {
		return SDKITAMTFOR;
	}

	public void setSDKITAMTFOR(Double sDKITAMTFOR) {
		SDKITAMTFOR = sDKITAMTFOR;
	}

	public String getSDKITDIRTY() {
		return SDKITDIRTY;
	}

	public void setSDKITDIRTY(String sDKITDIRTY) {
		SDKITDIRTY = sDKITDIRTY;
	}

	public String getSDOCITT() {
		return SDOCITT;
	}

	public void setSDOCITT(String sDOCITT) {
		SDOCITT = sDOCITT;
	}

	public Double getSDOCCARDNO() {
		return SDOCCARDNO;
	}

	public void setSDOCCARDNO(Double sDOCCARDNO) {
		SDOCCARDNO = sDOCCARDNO;
	}

	public String getSDPMPN() {
		return SDPMPN;
	}

	public void setSDPMPN(String sDPMPN) {
		SDPMPN = sDPMPN;
	}

	public Double getSDPNS() {
		return SDPNS;
	}

	public void setSDPNS(Double sDPNS) {
		SDPNS = sDPNS;
	}

	@Override
	public String toString() {
		return "F4211 [id=" + id + ", SDKCOO=" + SDKCOO + ", SDDOCO=" + SDDOCO + ", SDDCTO=" + SDDCTO + ", SDLNID="
				+ SDLNID + ", SDSFXO=" + SDSFXO + ", SDMCU=" + SDMCU + ", SDCO=" + SDCO + ", SDOKCO=" + SDOKCO
				+ ", SDOORN=" + SDOORN + ", SDOCTO=" + SDOCTO + ", SDOGNO=" + SDOGNO + ", SDRKCO=" + SDRKCO
				+ ", SDRORN=" + SDRORN + ", SDRCTO=" + SDRCTO + ", SDRLLN=" + SDRLLN + ", SDDMCT=" + SDDMCT
				+ ", SDDMCS=" + SDDMCS + ", SDAN8=" + SDAN8 + ", SDSHAN=" + SDSHAN + ", SDPA8=" + SDPA8 + ", SDDRQJ="
				+ SDDRQJ + ", SDTRDJ=" + SDTRDJ + ", SDPDDJ=" + SDPDDJ + ", SDADDJ=" + SDADDJ + ", SDIVD=" + SDIVD
				+ ", SDCNDJ=" + SDCNDJ + ", SDDGL=" + SDDGL + ", SDRSDJ=" + SDRSDJ + ", SDPEFJ=" + SDPEFJ + ", SDPPDJ="
				+ SDPPDJ + ", SDVR01=" + SDVR01 + ", SDVR02=" + SDVR02 + ", SDITM=" + SDITM + ", SDLITM=" + SDLITM
				+ ", SDAITM=" + SDAITM + ", SDLOCN=" + SDLOCN + ", SDLOTN=" + SDLOTN + ", SDFRGD=" + SDFRGD
				+ ", SDTHGD=" + SDTHGD + ", SDFRMP=" + SDFRMP + ", SDTHRP=" + SDTHRP + ", SDEXDP=" + SDEXDP
				+ ", SDDSC1=" + SDDSC1 + ", SDDSC2=" + SDDSC2 + ", SDLNTY=" + SDLNTY + ", SDNXTR=" + SDNXTR
				+ ", SDLTTR=" + SDLTTR + ", SDEMCU=" + SDEMCU + ", SDRLIT=" + SDRLIT + ", SDKTLN=" + SDKTLN
				+ ", SDCPNT=" + SDCPNT + ", SDRKIT=" + SDRKIT + ", SDKTP=" + SDKTP + ", SDSRP1=" + SDSRP1 + ", SDSRP2="
				+ SDSRP2 + ", SDSRP3=" + SDSRP3 + ", SDSRP4=" + SDSRP4 + ", SDSRP5=" + SDSRP5 + ", SDPRP1=" + SDPRP1
				+ ", SDPRP2=" + SDPRP2 + ", SDPRP3=" + SDPRP3 + ", SDPRP4=" + SDPRP4 + ", SDPRP5=" + SDPRP5 + ", SDUOM="
				+ SDUOM + ", SDUORG=" + SDUORG + ", SDSOQS=" + SDSOQS + ", SDSOBK=" + SDSOBK + ", SDSOCN=" + SDSOCN
				+ ", SDSONE=" + SDSONE + ", SDUOPN=" + SDUOPN + ", SDQTYT=" + SDQTYT + ", SDQRLV=" + SDQRLV
				+ ", SDCOMM=" + SDCOMM + ", SDOTQY=" + SDOTQY + ", SDUPRC=" + SDUPRC + ", SDAEXP=" + SDAEXP
				+ ", SDAOPN=" + SDAOPN + ", SDPROV=" + SDPROV + ", SDTPC=" + SDTPC + ", SDAPUM=" + SDAPUM + ", SDLPRC="
				+ SDLPRC + ", SDUNCS=" + SDUNCS + ", SDECST=" + SDECST + ", SDCSTO=" + SDCSTO + ", SDTCST=" + SDTCST
				+ ", SDINMG=" + SDINMG + ", SDPTC=" + SDPTC + ", SDRYIN=" + SDRYIN + ", SDDTBS=" + SDDTBS + ", SDTRDC="
				+ SDTRDC + ", SDFUN2=" + SDFUN2 + ", SDASN=" + SDASN + ", SDPRGR=" + SDPRGR + ", SDCLVL=" + SDCLVL
				+ ", SDCADC=" + SDCADC + ", SDKCO=" + SDKCO + ", SDDOC=" + SDDOC + ", SDDCT=" + SDDCT + ", SDODOC="
				+ SDODOC + ", SDODCT=" + SDODCT + ", SDOKC=" + SDOKC + ", SDPSN=" + SDPSN + ", SDDELN=" + SDDELN
				+ ", SDTAX1=" + SDTAX1 + ", SDTXA1=" + SDTXA1 + ", SDEXR1=" + SDEXR1 + ", SDATXT=" + SDATXT
				+ ", SDPRIO=" + SDPRIO + ", SDRESL=" + SDRESL + ", SDBACK=" + SDBACK + ", SDSBAL=" + SDSBAL
				+ ", SDAPTS=" + SDAPTS + ", SDLOB=" + SDLOB + ", SDEUSE=" + SDEUSE + ", SDDTYS=" + SDDTYS + ", SDNTR="
				+ SDNTR + ", SDVEND=" + SDVEND + ", SDCARS=" + SDCARS + ", SDMOT=" + SDMOT + ", SDROUT=" + SDROUT
				+ ", SDSTOP=" + SDSTOP + ", SDZON=" + SDZON + ", SDCNID=" + SDCNID + ", SDFRTH=" + SDFRTH + ", SDSHCM="
				+ SDSHCM + ", SDSHCN=" + SDSHCN + ", SDSERN=" + SDSERN + ", SDUOM1=" + SDUOM1 + ", SDPQOR=" + SDPQOR
				+ ", SDUOM2=" + SDUOM2 + ", SDSQOR=" + SDSQOR + ", SDUOM4=" + SDUOM4 + ", SDITWT=" + SDITWT
				+ ", SDWTUM=" + SDWTUM + ", SDITVL=" + SDITVL + ", SDVLUM=" + SDVLUM + ", SDRPRC=" + SDRPRC
				+ ", SDORPR=" + SDORPR + ", SDORP=" + SDORP + ", SDCMGP=" + SDCMGP + ", SDGLC=" + SDGLC + ", SDCTRY="
				+ SDCTRY + ", SDFY=" + SDFY + ", SDSO01=" + SDSO01 + ", SDSO02=" + SDSO02 + ", SDSO03=" + SDSO03
				+ ", SDSO04=" + SDSO04 + ", SDSO05=" + SDSO05 + ", SDSO06=" + SDSO06 + ", SDSO07=" + SDSO07
				+ ", SDSO08=" + SDSO08 + ", SDSO09=" + SDSO09 + ", SDSO10=" + SDSO10 + ", SDSO11=" + SDSO11
				+ ", SDSO12=" + SDSO12 + ", SDSO13=" + SDSO13 + ", SDSO14=" + SDSO14 + ", SDSO15=" + SDSO15
				+ ", SDACOM=" + SDACOM + ", SDCMCG=" + SDCMCG + ", SDRCD=" + SDRCD + ", SDGRWT=" + SDGRWT + ", SDGWUM="
				+ SDGWUM + ", SDSBL=" + SDSBL + ", SDSBLT=" + SDSBLT + ", SDLCOD=" + SDLCOD + ", SDUPC1=" + SDUPC1
				+ ", SDUPC2=" + SDUPC2 + ", SDUPC3=" + SDUPC3 + ", SDSWMS=" + SDSWMS + ", SDUNCD=" + SDUNCD
				+ ", SDCRMD=" + SDCRMD + ", SDCRCD=" + SDCRCD + ", SDCRR=" + SDCRR + ", SDFPRC=" + SDFPRC + ", SDFUP="
				+ SDFUP + ", SDFEA=" + SDFEA + ", SDFUC=" + SDFUC + ", SDFEC=" + SDFEC + ", SDURCD=" + SDURCD
				+ ", SDURDT=" + SDURDT + ", SDURAT=" + SDURAT + ", SDURAB=" + SDURAB + ", SDURRF=" + SDURRF
				+ ", SDTORG=" + SDTORG + ", SDUSER=" + SDUSER + ", SDPID=" + SDPID + ", SDJOBN=" + SDJOBN + ", SDUPMJ="
				+ SDUPMJ + ", SDTDAY=" + SDTDAY + ", SDSO16=" + SDSO16 + ", SDSO17=" + SDSO17 + ", SDSO18=" + SDSO18
				+ ", SDSO19=" + SDSO19 + ", SDSO20=" + SDSO20 + ", SDIR01=" + SDIR01 + ", SDIR02=" + SDIR02
				+ ", SDIR03=" + SDIR03 + ", SDIR04=" + SDIR04 + ", SDIR05=" + SDIR05 + ", SDSOOR=" + SDSOOR
				+ ", SDVR03=" + SDVR03 + ", SDDEID=" + SDDEID + ", SDPSIG=" + SDPSIG + ", SDRLNU=" + SDRLNU
				+ ", SDPMDT=" + SDPMDT + ", SDRLTM=" + SDRLTM + ", SDRLDJ=" + SDRLDJ + ", SDDRQT=" + SDDRQT
				+ ", SDADTM=" + SDADTM + ", SDOPTT=" + SDOPTT + ", SDPDTT=" + SDPDTT + ", SDPSTM=" + SDPSTM
				+ ", SDXDCK=" + SDXDCK + ", SDXPTY=" + SDXPTY + ", SDDUAL=" + SDDUAL + ", SDBSC=" + SDBSC + ", SDCBSC="
				+ SDCBSC + ", SDCORD=" + SDCORD + ", SDDVAN=" + SDDVAN + ", SDPEND=" + SDPEND + ", SDRFRV=" + SDRFRV
				+ ", SDMCLN=" + SDMCLN + ", SDSHPN=" + SDSHPN + ", SDRSDT=" + SDRSDT + ", SDPRJM=" + SDPRJM
				+ ", SDOSEQ=" + SDOSEQ + ", SDMERL=" + SDMERL + ", SDHOLD=" + SDHOLD + ", SDHDBU=" + SDHDBU
				+ ", SDDMBU=" + SDDMBU + ", SDBCRC=" + SDBCRC + ", SDODLN=" + SDODLN + ", SDOPDJ=" + SDOPDJ
				+ ", SDXKCO=" + SDXKCO + ", SDXORN=" + SDXORN + ", SDXCTO=" + SDXCTO + ", SDXLLN=" + SDXLLN
				+ ", SDXSFX=" + SDXSFX + ", SDPOE=" + SDPOE + ", SDPMTO=" + SDPMTO + ", SDANBY=" + SDANBY + ", SDPMTN="
				+ SDPMTN + ", SDNUMB=" + SDNUMB + ", SDAAID=" + SDAAID + ", SDPRAN8=" + SDPRAN8 + ", SDSPATTN="
				+ SDSPATTN + ", SDPRCIDLN=" + SDPRCIDLN + ", SDCCIDLN=" + SDCCIDLN + ", SDSHCCIDLN=" + SDSHCCIDLN
				+ ", SDOPPID=" + SDOPPID + ", SDOSTP=" + SDOSTP + ", SDUKID=" + SDUKID + ", SDCATNM=" + SDCATNM
				+ ", SDALLOC=" + SDALLOC + ", SDFULPID=" + SDFULPID + ", SDALLSTS=" + SDALLSTS + ", SDOSCORE="
				+ SDOSCORE + ", SDOSCOREO=" + SDOSCOREO + ", SDCMCO=" + SDCMCO + ", SDKITID=" + SDKITID
				+ ", SDKITAMTDOM=" + SDKITAMTDOM + ", SDKITAMTFOR=" + SDKITAMTFOR + ", SDKITDIRTY=" + SDKITDIRTY
				+ ", SDOCITT=" + SDOCITT + ", SDOCCARDNO=" + SDOCCARDNO + ", SDPMPN=" + SDPMPN + ", SDPNS=" + SDPNS
				+ "]";
	}
