/**
 * CadastrarNfMercantilResponse.java
 *
...
public class CadastrarNfMercantilResponse  implements java.io.Serializable {
    private br.com.compliancefiscal.modelo.integracao.domain.v1.tiposGenericos.LoteIntWSResponse loteWSResponse;

    public CadastrarNfMercantilResponse() {
    }
    ...
    /**
     * Gets the loteWSResponse value for this CadastrarNfMercantilResponse.
     * 
    ...
    /**
     * Sets the loteWSResponse value for this CadastrarNfMercantilResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarNfMercantilResponse)) return false;
        CadastrarNfMercantilResponse other = (CadastrarNfMercantilResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarNfMercantilResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services.compliancefiscal.com.br/integracao/services/v1/nfMercantilService", ">cadastrarNfMercantilResponse"));
