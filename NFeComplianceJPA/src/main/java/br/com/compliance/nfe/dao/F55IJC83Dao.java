...
public class F55IJC83Dao {
	...
	public List<F55IJC83> listF55IJC83ById(F55IJC80Id id) {
		 ...
		 * "WHERE f55IJC83.JCBNNF = :JCBNNF " + "AND f55IJC83.JCBSER = :JCBSER " +
		 * "AND f55IJC83.JCN001 = :JCN001 " + "AND f55IJC83.JCDCT = :JCDCT";
		 * 
		 ...
		 * 
		 * try{ listF55IJC83 = query.getResultList(); }catch(NoResultException ex){
		 * 
		 * }
		 * 
		 * return listF55IJC83;
	...
	public F55IJC83 getF55IJC83ById(F55IJC80Id id) {
		 ...
		 * query.setParameter("JCDCT", id.getJCDCT());
		 * 
		 * try{ f55IJC83 = (F55IJC83)query.getSingleResult(); }catch(NoResultException
		 * ex){
		 * 
		 * }
		 * 
	...
	public void insertF55IJC83(F55IJC83 f) throws JDBCException, SQLException {
