...
@Embeddable
public class F55IJC80Id implements Serializable{
	...
	public F55IJC80Id(Integer jCBNNF, String jCBSER, Integer jCN001, String jCDCT) {
		super();
		JCBNNF = jCBNNF;
		JCBSER = jCBSER;
		JCN001 = jCN001;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		F55IJC80Id other = (F55IJC80Id) obj;
		if (JCBNNF == null) {
